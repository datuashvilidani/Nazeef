...
const Header = ({ onOpenAuth }) => {
    ...
    return (
        <header className="sticky top-0 z-50">
            {/* Main Header Bar */}
            <div
                className="relative flex items-center justify-between px-6 md:px-8 py-4 border-b border-blue-100 shadow-sm  
        bg-gradient-to-r from-[#add6fd] via-white to-[#add6fd]"
            ...
            <div
                className={`fixed left-0 right-0 top-[72px] bg-white/95 backdrop-blur-md border-b border-blue-100 transition-all duration-300 ease-in-out origin-top ${isMenuOpen ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0 pointer-events-none"
